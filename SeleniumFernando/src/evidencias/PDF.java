...
public class PDF {
	// private static String FILE = "c:/Report/FirstPdf1000.pdf";
	...
	public PDF(String FILE, ArrayList prints) {
		// this.FILE=FILE;
		try {
			...
			for (int i = 0; i < prints.size(); i++) {
				// System.out.println((String) prints.get(i));
	...
	public static void addImage(Document document, String nome)
		...
		figura.setWidthPercentage(50);
		figura.setWidthPercentage(50);

		figura.setScaleToFitLineWhenOverflow(true);
		document.add(figura);
	...
	private static void addMetaData(Document document) {
		document.addTitle("Relatório Selenium");
		document.addSubject("Using iText");
		document.addKeywords("Java, PDF, iText");
		document.addAuthor("fernado.f.andrade");
		document.addCreator("fernando.f.andrade");
	}
	...
	private static void addTitlePage(Document document) throws DocumentException {
		...
		// preface.add(new Paragraph("Relatório Evidências", catFont));
